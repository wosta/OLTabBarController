...
#import "DJMemberViewController.h"
#import "DJMessageViewController.h"
#import "DJCartViewController.h"
...
- (CYLTabBarController *)tabBarController {
    if (_tabBarController == nil) {
        DJMyViewController *firstViewController = [[DJMyViewController alloc] init];
        UIViewController *firstNavigationController = [[CYLBaseNavigationController alloc]
                                                       initWithRootViewController:firstViewController];
        
        DJMessageViewController *secondViewController = [[DJMessageViewController alloc] init];
        UIViewController *secondNavigationController = [[CYLBaseNavigationController alloc]
                                                        initWithRootViewController:secondViewController];
        
        DJMemberViewController *thirdViewController = [[DJMemberViewController alloc] init];
        UIViewController *thirdNavigationController = [[CYLBaseNavigationController alloc]
                                                       initWithRootViewController:thirdViewController];
        
        DJCartViewController *fourthViewController = [[DJCartViewController alloc] init];
...
+ (void)customizeTabBarAppearance:(CYLTabBarController *)tabBarController {
    ...
    [[UITabBar appearance] setSelectionIndicatorImage:[self imageFromColor:[UIColor whiteColor] forSize:CGSizeMake([UIScreen mainScreen].bounds.size.width / allItemsInTabBarCount, 49.f) withCornerRadius:0]];
